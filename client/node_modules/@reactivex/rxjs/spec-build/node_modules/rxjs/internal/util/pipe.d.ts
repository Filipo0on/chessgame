...
export declare function pipe<T>(...operators: MonoTypeOperatorFunction<T>[]): <R extends T>(source: Observable<R>) => Observable<R>;
export declare function pipe<T>(...operators: UnaryFunction<T, T>[]): <R extends T>(source: R) => R;
/** @internal */
